    ...
    if (!stocks || stocks.length === 0) {
        return (
            <div className="text-center py-12 bg-gray-900/50 rounded-lg border border-gray-800">
                <h3 className="text-xl font-medium text-gray-300 mb-2">自選股是空的</h3>
                <p className="text-gray-500 mb-6">新增股票即可追蹤走勢並設定警示。</p>
            </div>
        );
    }
            ...
            <table className="w-full text-left text-sm border-collapse">
                <thead className="bg-white/5 text-gray-400 font-medium border-b border-white/10">
                    <tr>
                        ...
                        <th className="px-6 py-4 font-semibold tracking-wide">代號</th>
                        <th className="px-6 py-4 font-semibold tracking-wide">價格</th>
                        <th className="px-6 py-4 font-semibold tracking-wide">漲跌</th>
                            ...
                            <tr key={stock.symbol} className="hover:bg-white/5 transition-colors group">
                                ...
                                <td className="px-6 py-4 text-right">
                                    <div className="flex items-center justify-end space-x-3 opacity-80 group-hover:opacity-100 transition-opacity">
                                        ...
                                        >
                                            <button className="p-2.5 rounded-full text-gray-400 hover:text-white hover:bg-white/10 transition-all border border-transparent hover:border-white/10" title="新增警示">
